...
SUMMARY = {
    ...
    "firstspend": "when each lock was first spent from, ordered by time",
    "firstreveal": "when each key was first revealed, ordered by time",
    "blockstats": "per-block statistics derived from a graph",
    "price": "an external price series, and one price per block from it",
